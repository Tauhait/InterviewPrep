<h2>  Two Sum III - Data structure design</h2><hr><div><p>Design a data structure that accepts a stream of integers and checks if it has a pair of integers that sum up to a particular value.</p>
