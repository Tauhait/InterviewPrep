class LFUCache {
    ...
    /* Map from frequency as key to LinkedHashSet of keys with corresponding count
    ...
    public int get(int key) {
        ...
        countToLRUKeys.get(count).remove(key); /* remove key from current count (since we will inc count)  takes O(1) time complexity */
